...
"""
1.define state: dp[i] represent facing nums[i...n-1] winner number
2.dp[0]
3.dp[n-1] = nums[n-1]
4.transit function dp[i] = max{nums[i] - dp[i+1], nums[i] + nums[i+1] - dp[i+2], nums[i] + nums[i+1] + nums[i+2] - dp[i+3]}
"""
class Solution:
