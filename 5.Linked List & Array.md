...
1.Subarray sum at least / at most / equals K problem and nums are positive(套用三套模板，详见第九章)
...
这种情况最难implement, 需要在for循环里写两个while loop, 一个用sliding window udpate res, 另一个用clean the deque to maintain an increasing or decreasing deque. 
TODO:862
