...
- [0094.Binary Tree Inorder Traversal](Solutions/0094.Binary_Tree_Inorder_Traversal.py)(E) 
  Solution:memorize the iterative version using stack. 
  solution 1: trivial - in order traversal of BST - O(N), O(N).
  solution 2: in order traversal of BST (iteratively) - O(k+H) where H is height of tree. 非递归: 记不住啊<br>
  非递归: 中序遍历顺序：左中右，while 一直找到最左边的结点，然后stack pop, then put it in res, curr = curr.right。
- [0145.Binary_Tree_Postorder_Traversal](Solutions/0145.Binary_Tree_Postorder_Traversal.py) (M) 
...
- [0894.All_Possible_Full_Binary_Trees.py ](Solutions/0894.All_Possible_Full_Binary_Trees.py ) (M)
- [0538.Convert_BST_to_Greater_Tree.py](Solutions/0538.Convert_BST_to_Greater_Tree.py) (M)
use a global self.pre_sum as we reverse_in_order traversal the tree recurssively or iteratively.

### [二叉树深度、子树]() 
> 二叉树的深度
- [0104.Maximum Depth of Binary Tree.java](Solutions/0104.Maximum_Depth_of_Binary_Tree.py)(E)
...
- [0111.Minimum_Depth_of_Binary_Tree.py](Solutions/0111.Minimum_Depth_of_Binary_Tree.py)(E)
